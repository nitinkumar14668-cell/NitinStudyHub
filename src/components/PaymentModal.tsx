      ...
      >
        ...
        <AnimatePresence mode="wait">
          {step === PaymentStep.QR_SCAN && (
            ...
            >
              <h2 className="text-2xl font-bold mb-2">Scan & Pay</h2>
              <p className="text-gray-500 mb-8">Scan this QR code using any UPI app like Google Pay, PhonePe, or FamPay.</p>
              
              <div className="bg-gray-50 p-6 rounded-3xl inline-block border-2 border-dashed border-gray-200 mb-8">
                <QRCodeSVG value={upiLink} size={180} />
              </div>

              <div className="bg-blue-50 rounded-2xl p-4 flex items-center justify-between gap-4 mb-8">
                <div className="text-left">
                  <p className="text-xs font-bold text-blue-600 uppercase tracking-widest">UPI ID</p>
                  <p className="font-mono text-sm text-blue-900">{upiId}</p>
                </div>
                <button
          ...
          {step === PaymentStep.UPLOAD_SCREENSHOT && (
            ...
            >
              ...
              <p className="text-gray-500 mb-8">Please upload a screenshot of your successful transaction.</p>
              ...
              <div className="mb-8">
                ...
                <label
                  ...
                  className={`border-2 border-dashed rounded-3xl p-12 flex flex-col items-center gap-4 cursor-pointer transition-all ${
                    screenshot ? 'border-green-500 bg-green-50' : 'border-gray-200 hover:border-blue-400 hover:bg-blue-50'
                  }`}
                >
                  {screenshot ? (
                    <>
                      ...
                      <div>
                        <p className="font-bold text-green-700">{screenshot.name}</p>
                    ...
                    <>
                      ...
                      <div>
                        <p className="font-bold text-gray-700">Upload Screenshot</p>
          ...
          {step === PaymentStep.VERIFYING && (
            ...
            >
              ...
              <h2 className="text-2xl font-bold mb-4 italic">Verifying Payment...</h2>
              <p className="text-gray-500 mb-2">Our system is checking your transaction screenshot.</p>
              <p className="text-sm text-blue-600 font-medium">Estimated time: 5-10 seconds</p>
              
              <div className="mt-12 bg-gray-50 p-4 rounded-2xl text-left border border-gray-100">
                ...
                <motion.div
                  ...
                  animate={{ opacity: 1 }}
                  transition={{ delay: 1 }}
                  className="text-[10px] font-mono text-gray-400 space-y-1"
                >
          ...
          {step === PaymentStep.SUCCESS && (
            ...
            >
              ...
              <h2 className="text-3xl font-black mb-4">Payment Verified!</h2>
              <p className="text-gray-500 mb-12">Your payment has been successfully confirmed. You can now download your notes.</p>
